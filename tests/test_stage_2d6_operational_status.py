...
def test_stage_2d6_operational_status_ready():
...
def test_stage_2d6_operational_status_exposing_is_busy():
    runtime = RuntimeAssembler().build()
...
def test_stage_2d6_status_full_includes_operational_status():
