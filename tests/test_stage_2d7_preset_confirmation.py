...
def test_stage_2d7_normal_preset_apply_remains_backward_compatible():
...
def test_stage_2d7_high_impact_preset_requires_confirmation():
    client = TestClient(app)
...
def test_stage_2d7_high_impact_preset_apply_succeeds_when_confirmed():
    client = TestClient(app)
...
def test_stage_2d7_preview_still_does_not_require_confirmation():
    client = TestClient(app)
